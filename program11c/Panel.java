...
public class Panel extends JPanel {
    ...
    public Panel(int cols, int bigCol) {
        this(cols, bigCol, -1);
    }

    public Panel(int cols, int bigCol, int bigRow) {
    ...
    public Panel cell(Component component) {
        return cell(component, getHLayout(component), getVLayout(component), null);
    }

    public Panel cell(Component component, Layout hLayout) {
        return cell(component, hLayout, getVLayout(component), null);
    }

    public Panel cell(Component component, Layout hLayout, Layout vLayout) {
        return cell(component, hLayout, vLayout, null);
    }

    public Panel cell(Component component, Insets insets) {
        assert insets != null;

        return cell(component, getHLayout(component), getVLayout(component), insets);
    }

    private Panel cell(Component component, Layout hLayout, Layout vLayout, Insets insets) {
